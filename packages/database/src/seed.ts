...
const input: Omit<Cryptocurrency, "createdAt" | "updatedAt" | "deletedAt">[] = [
	// {
	// 	userId,
	...
	{
		userId,
		id: "cl9ws2f6w0000vdjzw7n9mhbk-ergo",
		displayName: "Ergo",
		marketId: "ergo",
		currency: "aud",
		balance: new Decimal(237.7513),
	...
	// {
	// 	userId,
	// 	id: "cl9ws2f6w0000vdjzw7n9mhbk-diff",
