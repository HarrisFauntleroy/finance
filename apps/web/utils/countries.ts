...
export const countryByCurrency: Record<string, string> = {
  AFN: 'Afeganistão',
  ZAR: 'África do Sul',
  ALL: 'Albânia',
  EUR: 'Vaticano',
  AOA: 'Angola',
  XCD: 'São Vicente e Granadinas',
  AAD: 'Antártida',
  SAR: 'Arábia Saudita',
  DZD: 'Argélia',
  ARS: 'Argentina',
  ...
  HRK: 'Croácia',
  CUP: 'Cuba',
  ANG: 'São Martinho (Países Baixos)',
  DKK: 'ilhas Faroe',
  DJF: 'Djibouti',
  EGP: 'Egito',
  USD: 'Timor-Leste',
  ...
  HUF: 'Hungria',
  YER: 'Iêmen',
  NOK: 'Svalbard e Jan Mayen',
  KYD: 'Ilhas Cayman',
  NZD: 'Toquelau',
  FKP: 'Ilhas Falkland (Malvinas)',
  SBD: 'Ilhas Salomão',
  INR: 'Índia',
  IDR: 'Indonésia',
  IRR: 'Irã',
  IQD: 'Iraque',
  ISK: 'Islândia',
  ILS: 'Territórios Palestinos Ocupados',
  JMD: 'Jamaica',
  JPY: 'Japão',
  JOD: 'Jordânia',
  KWD: 'Kuwait',
